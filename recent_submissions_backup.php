		...
		<div class = "main_container">
			<?php 
				...
				while ($row = mysqli_fetch_assoc($result)) {
					...
					$sub_id = $row["sub_id"];
					$cid = $row["cid"];
					$message = "<b><a style = 'color: black;' href = 'display_source.php?cid=$cid&sub_id=$sub_id&practice=nil' title = 'View source' target = '_blank'>Compilation Error</a></b>";

					if($row["verdict"] == "Rejected") {
						$message = "<b><a style = 'color: red;' href = 'display_source.php?cid=$cid&sub_id=$sub_id&practice=nil' title = 'View source' target = '_blank'>Rejected</a></b>";
					}
					else if($row["verdict"] == "Accepted") {
						$message = "<b><a style = 'color: green;' href = 'display_source.php?cid=$cid&sub_id=$sub_id&practice=nil' title = 'View source' target = '_blank'>Accepted</a></b>";
					}
